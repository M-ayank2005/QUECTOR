...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">Nearby Shops</a>
    <a className="link link-hover">Trending Shops</a>
    <a className="link link-hover">Become a seller</a>
    <a className="link link-hover">Pay Later</a>
  </nav> 
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>QUECTO <br/>All the local stores in your neighbour</p>
  </aside> 

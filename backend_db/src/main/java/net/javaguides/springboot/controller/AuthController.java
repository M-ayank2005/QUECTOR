...
import net.javaguides.springboot.entity.ERole;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(), 
               ...
               encoder.encode(signUpRequest.getPassword()),signUpRequest.getPhoneno(),signUpRequest.getAddress(),signUpRequest.getPincode());
